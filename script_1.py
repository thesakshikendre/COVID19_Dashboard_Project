...
with open('COVID19_Dashboard_Project/requirements.txt', 'w') as f:
    f.write(requirements_content)

# 2. Main README.md
readme_content = """# COVID-19 Global Trends & Policy Impact Dashboard
...
with open('COVID19_Dashboard_Project/README.md', 'w') as f:
