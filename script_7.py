# Create the main pipeline runner and utility modules

# 1. Create main pipeline runner
main_pipeline_code = '''"""
...
# Save main pipeline
with open('COVID19_Dashboard_Project/src/main_pipeline.py', 'w') as f:
    f.write(main_pipeline_code)

print("✅ Main pipeline module created successfully!")